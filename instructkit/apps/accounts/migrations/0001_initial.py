    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github', models.URLField(blank=True, null=True, verbose_name='Link to public Github account')),
                ('website', models.URLField(blank=True, null=True, verbose_name='Link to personal portfolio site')),
                ('linkedin', models.URLField(blank=True, null=True, verbose_name='Link to LinkedIn profile')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', django.contrib.postgres.fields.jsonb.JSONField(default=accounts.models.skill_defaults)),
